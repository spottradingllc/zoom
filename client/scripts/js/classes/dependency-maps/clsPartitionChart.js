function PartitionChart(d3, ko, parent, divName) {
    ...
    // creat the initial visual and layout
    ...
    self.update = function(source) {
        ...
        var gEnter = self.g.enter().append("svg:g")
                                   .attr("transform", function(d) { return "translate(" + self.x(d.y) + "," + self.y(d.x) + ")"; })
                                   .on("click", self.click);
        ...
        gEnter.append("svg:text")
              ...
              .attr("dy", ".35em")
              .style("opacity", function(d) { return d.dx * self.ky > 12 ? 1 : 0; })
    ...
    self.click = function(d) {
        ...
        t.select("rect")
         ...
         .attr("height", function(d) { return d.dx * self.ky; });
