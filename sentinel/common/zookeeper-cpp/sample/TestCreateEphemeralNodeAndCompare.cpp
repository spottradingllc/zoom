...
namespace Spot
{
  TestCreateEphemeralNodeAndCompare::TestCreateEphemeralNodeAndCompare( Logger::ILogger* logger, ZooKeeper::ZooKeeper* zooKeeper ) :
    m_logger( logger ),
  ...
  TestCreateEphemeralNodeAndCompare::~TestCreateEphemeralNodeAndCompare() noexcept
  {
  }


  void TestCreateEphemeralNodeAndCompare::StartUp()
  {
    try
    {
  ...
  void TestCreateEphemeralNodeAndCompare::Execute()
  {
    bool result = false;
  ...
  void TestCreateEphemeralNodeAndCompare::TearDown()
  {
  ...
  void TestCreateEphemeralNodeAndCompare::OnConnected( const std::string& host )
  {
