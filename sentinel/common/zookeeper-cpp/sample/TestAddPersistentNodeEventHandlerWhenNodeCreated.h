#ifndef TEST_ADD_PERSISTENT_NODE_EVENT_HANDLER_WHEN_NODE_CREATED_H
#define TEST_ADD_PERSISTENT_NODE_EVENT_HANDLER_WHEN_NODE_CREATED_H
...
namespace Spot
{
  class TestAddPersistentNodeEventHandlerWhenNodeCreated final :
    public ITest,
    public ZooKeeper::IZooKeeperSessionEventHandler,
    public ZooKeeper::IZooKeeperNodeEventHandler
  {
  public:
    TestAddPersistentNodeEventHandlerWhenNodeCreated( Logger::ILogger* logger, ZooKeeper::ZooKeeper* zooKeeper );
    virtual ~TestAddPersistentNodeEventHandlerWhenNodeCreated() noexcept;
