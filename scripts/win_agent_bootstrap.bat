...
C:\Python27\python.exe "C:\Program Files\Spot Trading LLC\zoom\server\spot\zoom\agent\scripts\win_install.py" --username spottrading\svc.python --password Pyth0n --startup auto install  >> %OUTPUTFILE%
