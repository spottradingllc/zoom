...
namespace Spot
{
  TestChangePersistentNodeAndCompare::TestChangePersistentNodeAndCompare( Logger::ILogger* logger, ZooKeeper::ZooKeeper* zooKeeper ) :
    m_logger( logger ),
  ...
  TestChangePersistentNodeAndCompare::~TestChangePersistentNodeAndCompare() noexcept
  {
  }


  void TestChangePersistentNodeAndCompare::StartUp()
  {
    try
    {
  ...
  void TestChangePersistentNodeAndCompare::Execute()
  {
    bool result = false;
  ...
  void TestChangePersistentNodeAndCompare::TearDown()
  {
  ...
  void TestChangePersistentNodeAndCompare::OnConnected( const std::string& host )
  {
