...
namespace Spot
{
  TestCreateSequentialEphemeralNodeAndCompare::TestCreateSequentialEphemeralNodeAndCompare( Logger::ILogger* logger, ZooKeeper::ZooKeeper* zooKeeper ) :
    m_logger( logger ),
  ...
  TestCreateSequentialEphemeralNodeAndCompare::~TestCreateSequentialEphemeralNodeAndCompare() noexcept
  {
  }


  void TestCreateSequentialEphemeralNodeAndCompare::StartUp()
  {
    try
    {
  ...
  void TestCreateSequentialEphemeralNodeAndCompare::Execute()
  {
    bool result = false;
  ...
  void TestCreateSequentialEphemeralNodeAndCompare::TearDown()
  {
  ...
  void TestCreateSequentialEphemeralNodeAndCompare::OnConnected( const std::string& host )
  {
