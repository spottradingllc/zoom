...
C:\Python27\python.exe "C:\Program Files\Spot Trading LLC\sentinel\source\util\win_install.py" --username spottrading\svc.python --password Pyth0n --startup auto install  >> %OUTPUTFILE%
