...
from source.common.job import Job
from source.common.enum import ApplicationType
from source.common.task import Task
from source.common.unique_queue import UniqueQueue
...
class ChildProcess(object):
    ...
    def add_work(self, work, immediate=False):
        """
        :type work: source.common.task.Task
        """
