...
from spot.zoom.common.constants import ZK_CONN_STRING, ZOOM_CONFIG
...
class Configuration(object):
    def __init__(self, zookeeper):
        ...
        try:
            ...
            self._pagerduty_default_api_key = pagerduty_settings.get('pagerduty_default_api_key')
    ...
    @property
    def pagerduty_default_api_key(self):
        return self._pagerduty_default_api_key
